...
DIRS_TO_LOOK_IN =
INCLUDED_LIB_NAME =
OBJ_FILES = $(OBJ_DIR)getArrSize.o $(OBJ_DIR)getDataType.o $(OBJ_DIR)createStr.o $(OBJ_DIR)myFree.o $(OBJ_DIR)printTable.o $(OBJ_DIR)loadingBarC.o $(OBJ_DIR)findPathC.o
TARGET = genericCPreReqs1
